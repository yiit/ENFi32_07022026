...
#define FEATURE_THINGSPEAK_EVENT        1  // Generates an event when requesting last value of a field in thingspeak via SendToHTTP(e.g. sendToHTTP,api.thingspeak.com,80,/channels/1667332/fields/5/last)
...
// --- Wifi Client Mode -----------------------------------------------------------------------------
#define DEFAULT_SSID                         "sofu"            // Enter your network SSID
#define DEFAULT_KEY                          "nototrrentplease" // Enter your network WPA key
